...
public class My_Pending_Order_adapter extends RecyclerView.Adapter<My_Pending_Order_adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView  tv_name ,tv_orderno, tv_status, tv_date, tv_time, tv_price, tv_item, relativetextstatus, tv_tracking_date,tv_email,user_address;
...
//            holder.relative_background.setBackgroundTintList(context.getResources().getColorStateList(R.color.colorPrimary));
...
//        holder.tv_cancel_time.setText(mList.getDelivery_time_from() + "-" + mList.getDelivery_time_to());
        ...
        holder.user_address.setText(mList.getDelivery_address());
