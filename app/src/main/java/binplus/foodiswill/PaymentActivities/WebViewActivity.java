package binplus.foodiswill.PaymentActivities;
...
import binplus.foodiswill.Utility.LoadingDialog;
import binplus.foodiswill.Utility.RSAUtility;
...
Session_management session_management;
    ...
    public void onCreate(Bundle bundle) {
        ...
        module=new Module(WebViewActivity.this);
        session_management=new Session_management(WebViewActivity.this);
            ...
            class MyJavaScriptInterface {
                ...
                public void processHTML(String html) {
                    ...
                    if (html.indexOf("Failure") != -1) {
                        ...
                        pay_status="Not Known";
                        status = "Status Not Known!";
                    }
                    module.showToast(status);
                    if(pay_status.equalsIgnoreCase("success"))
                    {
                        session_management.updatePaymentSection(mainIntent.getStringExtra(AvenuesParams.ORDER_ID),pay_status,mainIntent.getStringExtra(AvenuesParams.AMOUNT));
                    }
                    else
                    {
...
//                    startActivity(intent);
            ...
            try {
                String sccode=mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE).toLowerCase();
                Log.e("access_code",""+mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE));
                Log.e("merchant_id",""+mainIntent.getStringExtra(AvenuesParams.MERCHANT_ID));
                Log.e("order_id",""+mainIntent.getStringExtra(AvenuesParams.ORDER_ID));
                Log.e("currency",""+mainIntent.getStringExtra(AvenuesParams.CURRENCY));
                Log.e("amount",""+mainIntent.getStringExtra(AvenuesParams.AMOUNT));
                Log.e("redirect_url",""+mainIntent.getStringExtra(AvenuesParams.REDIRECT_URL));
                Log.e("cancel_url",""+mainIntent.getStringExtra(AvenuesParams.CANCEL_URL));
                Log.e("rsa_key_url",""+mainIntent.getStringExtra(AvenuesParams.RSA_KEY_URL));
                ...
                String postData = AvenuesParams.ACCESS_CODE + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE), "UTF-8") +
                        ...
                        "&" + AvenuesParams.REDIRECT_URL + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.REDIRECT_URL), "UTF-8") + "&" + AvenuesParams.CANCEL_URL + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.CANCEL_URL), "UTF-8") + "&" + AvenuesParams.ENC_VAL + "=" + URLEncoder.encode(encVal, "UTF-8");
                Log.e("possssssstt_ut",""+postData);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, mainIntent.getStringExtra(AvenuesParams.RSA_KEY_URL),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        LoadingDialog.cancelLoading();
                       Log.e("essspsppsr",""+response.toString());
